...
def generate_statistic():
    ...
    start_date = date(year=int(start_date[:4]),month=int(start_date[5:7]), day=int(start_date[8:]))
    end_date = date(year=int(end_date[:4]),month=int(end_date[5:7]), day=int(end_date[8:]))
